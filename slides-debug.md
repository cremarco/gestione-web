...
<div class="calendar-table-wrap">
  <table class="calendar-table calendar-table--compact calendar-table--animated">
    ...
    <tbody>
      ...
      <tr>
        <td>16 Aprile 2026</td>
        <td>08:30 - 11:30</td>
        <td>SA.006 (Sala PC)</td>
      </tr>
      <tr>
        <td>23 Aprile 2026</td>
        <td>08:30 - 11:30</td>
        <td>SA.006 (Sala PC)</td>
      </tr>
      <tr>
...
# Browser a confronto (filtro rapido)

Filtra per categoria: **agentici**, **basati su Chromium**, **Gecko**, **WebKit** e **privacy-first**.
...
<BrowserProfileSlide
  ...
  birth="2008"
  :characteristics='[
    "Browser generalista con forte integrazione con l ecosistema Google",
    "Motore Blink e JavaScript engine V8",
    "Aggiornamenti frequenti e ampio supporto estensioni"
  ]'
  :highlights='[
    "Ha spinto una forte accelerazione degli standard web moderni",
    "DevTools molto usati per debugging e performance",
    "Quota di mercato alta: influenza pratica su test e compatibilita"
  ]'
/>
...
<BrowserProfileSlide
  ...
  birth="2015 (versione Chromium dal 2020)"
  :characteristics='[
    "Base Chromium con integrazione nativa in Windows",
    "Modalita efficienza e funzioni enterprise",
    "Assistente AI e strumenti produttivita integrati"
  ]'
  :highlights='[
    "Supporto centralizzato tramite policy aziendali",
    "Buona compatibilita con siti ottimizzati per Chromium",
    "Stack sicurezza con SmartScreen e isolamento processi"
  ]'
/>
...
<BrowserProfileSlide
  ...
  producer="Opera Software"
  website="https://www.opera.com/"
  birth="1995"
  :characteristics='[
    "Browser orientato a funzionalita integrate di produttivita",
    "Base Chromium con personalizzazione dell interfaccia",
    "Sidebar, VPN integrata e ad blocker nativi"
  ]'
  :highlights='[
    "Storicamente ha introdotto idee riprese poi da altri browser",
    "Punta su utente consumer con strumenti gia pronti",
    "Offre varianti dedicate come Opera GX"
  ]'
/>
...
<BrowserProfileSlide
  ...
  producer="Brave Software"
  website="https://brave.com/"
  birth="2016"
  :characteristics='[
    "Browser Chromium privacy-first",
    "Blocco tracker e ads di default",
    "Assistente AI Brave Leo integrato"
  ]'
  :highlights='[
    "Modello privacy orientato al minimo tracciamento",
    "Approccio aggressivo alla protezione lato utente",
    "Include funzionalita come Brave Search e Tor windows private"
  ]'
/>
...
<BrowserProfileSlide
  ...
  producer="Vivaldi Technologies"
  website="https://vivaldi.com/"
  birth="2016"
  :characteristics='[
    "Browser altamente personalizzabile su base Chromium",
    "Tab management avanzato con stack e tiling",
    "Funzioni integrate: mail, calendar e notes"
  ]'
  :highlights='[
    "Pensato per power users con workflow complessi",
    "Interfaccia modulare con molte opzioni native",
    "Riduce dipendenza da estensioni per funzioni comuni"
  ]'
/>
...
<BrowserProfileSlide
  ...
  producer="The Browser Company"
  website="https://arc.net/"
  birth="2022 beta, 2023 rilascio pubblico"
  :characteristics='[
    "Browser Chromium focalizzato su UX e organizzazione",
    "Concetto di Spaces e sidebar persistente",
    "Automazioni e funzioni AI Arc Max"
  ]'
  :highlights='[
    "Ha rilanciato il tema browser come ambiente di lavoro",
    "Interfaccia non convenzionale rispetto ai browser classici",
    "Forte enfasi su flussi multitask e collaborazione personale"
  ]'
/>
...
<BrowserProfileSlide
  ...
  birth="2004"
  :characteristics='[
    "Browser indipendente con motore Gecko",
    "Forte attenzione a standard aperti e privacy",
    "Ampio ecosistema di estensioni"
  ]'
  :highlights='[
    "Alternativa non Chromium importante per interoperabilita",
    "Enhanced Tracking Protection attiva per default",
    "Tradizione forte nel supporto alla comunita open web"
  ]'
/>
...
<BrowserProfileSlide
  ...
  birth="2003"
  :characteristics='[
    "Browser di default su ecosistema Apple",
    "Motore WebKit con forte ottimizzazione energetica",
    "Integrazione stretta con iCloud e funzioni sistema"
  ]'
  :highlights='[
    "Punto di riferimento per performance su macOS e iOS",
    "Scelte privacy come Intelligent Tracking Prevention",
    "Influenza rilevante nel supporto delle API mobile"
  ]'
/>
...
<BrowserProfileSlide
  ...
  producer="The Tor Project"
  website="https://www.torproject.org/"
  birth="2008"
  :characteristics='[
    "Browser orientato all anonimato basato su Firefox ESR",
    "Instrada il traffico nella rete Tor",
    "Configurazione hardening contro fingerprinting"
  ]'
  :highlights='[
    "Riduce tracciabilita della navigazione in scenari sensibili",
    "Utile per ricerca su temi critici e tutela fonti",
    "Bilancia anonimato e possibile impatto su velocita"
  ]'
/>
...
<BrowserProfileSlide
  ...
  birth="2022"
  :characteristics='[
    "Browser orientato alla privacy con impostazioni semplici",
    "Blocca tracker e gestisce richieste cookie automaticamente",
    "Integrazione nativa con DuckDuckGo search"
  ]'
  :highlights='[
    "Approccio facile per utenti non tecnici",
    "Interfaccia minimal con focus su protezione immediata",
    "Ha esteso l offerta privacy del brand oltre il motore di ricerca"
  ]'
/>
...
# Timeline nascite browser (asse X = anno)
...
# Browser "particolari" (oltre i mainstream)

| Browser | Caratteristica unica | Quando usarlo |
| --- | --- | --- |
| **Tor Browser** | Traffico instradato nella rete Tor + hardening anti-fingerprinting | Ricerca sensibile e maggiore anonimato |
| **Lynx** | Browser solo testuale da terminale (niente UI grafica) | Test rapido contenuti, server e ambienti CLI |
| **Mullvad Browser** | Profilo uniforme pensato per ridurre la fingerprintability | Navigazione quotidiana orientata alla privacy |
...
# Esercizio guidato: prima pagina personale

Obiettivo: arrivare a una pagina `index.html` personale, funzionante e validabile, anche partendo da zero.

## Istruzione 0
Crea una cartella di lavoro con questi file.

```txt
pagina-personale/
  index.html   # qui scriverai la struttura HTML
  style.css    # qui scriverai lo stile CSS
  img/         # (opzionale) foto o immagini personali
```
...
# Passo 1: struttura minima

## Istruzione 1
Apri `index.html` e incolla questa base.
...
<html lang="it">
  <head>
    ...
    <title>Pagina personale di [Il tuo nome]</title> <!-- Cambia con il tuo nome -->
    <link rel="stylesheet" href="style.css" /> <!-- Collega il file CSS -->
  </head>
  <body>
    <!-- Nelle prossime slide riempiremo il body -->
  </body>
</html>
```
...
# Passo 2: intestazione personale

## Istruzione 2
Dentro `<body>`, crea intestazione e contenitore principale.

```html
<header>
  <h1>[Il tuo nome e cognome]</h1> <!-- Titolo principale della pagina -->
  <p>Studentessa/Studente di [Corso di laurea]</p> <!-- Una riga di presentazione -->
</header>

<main>
  <!-- Qui inserirai sezioni: chi sono, interessi, contatti -->
</main>
```
...
# Passo 3: sezione "Chi sono"

## Istruzione 3
Aggiungi una breve presentazione dentro `<main>`.

```html
<section id="chi-sono">
  <h2>Chi sono</h2> <!-- Titolo della sezione -->
  <p>
    Mi chiamo [nome], ho [eta] anni e studio [corso]. <!-- Scrivi 2-3 frasi personali -->
  </p>
</section>
```
...
# Passo 4: inserire una foto

## Istruzione 4
Aggiungi una tua immagine con testo alternativo.

```html
<section id="foto">
  <h2>La mia foto</h2>
  <img src="img/profilo.jpg" alt="Foto ritratto di [nome]" width="220" /> <!-- alt descrive l'immagine -->
</section>
```
...
# Passo 5: interessi personali

## Istruzione 5
Crea una lista con almeno 3 interessi.

```html
<section id="interessi">
  <h2>I miei interessi</h2>
  <ul>
    <li>[Interesse 1]</li> <!-- Esempio: cinema -->
    <li>[Interesse 2]</li> <!-- Esempio: musica -->
    <li>[Interesse 3]</li> <!-- Esempio: sport -->
  </ul>
</section>
```
...
# Passo 6: contatti e link

## Istruzione 6
Aggiungi almeno un link di contatto funzionante.

```html
<section id="contatti">
  <h2>Contatti</h2>
  <ul>
    <li><a href="mailto:nome.cognome@email.com">Email</a></li> <!-- Link email -->
    <li><a href="https://www.instagram.com/tuo_profilo/" target="_blank" rel="noopener noreferrer">Instagram</a></li> <!-- Link social -->
  </ul>
</section>
```
...
```html
<footer>
  <p>&copy; 2026 [Il tuo nome]</p> <!-- Firma finale della pagina -->
</footer>
```
...
# Passo 8: stile base (style.css)

## Istruzione 8
Apri `style.css` e incolla questo CSS iniziale.
...
# Passo 9: versione mobile

## Istruzione 9
Aggiungi una regola responsive per smartphone.

```css
/* Migliora la lettura su schermi piccoli */
@media (max-width: 600px) {
  body {
    padding: 14px; /* Riduce gli spazi su mobile */
  }

  img {
    max-width: 100%; /* Evita immagini tagliate */
    height: auto;
  }
}
```
...
# Materiali opzionali da scaricare

## Istruzione 10
Se non hai una foto o icone pronte, usa risorse gratuite.

- Foto gratuite: [Pexels](https://www.pexels.com/it-it/) oppure [Unsplash](https://unsplash.com/)
- Icone gratuite: [Heroicons](https://heroicons.com/)
- Placeholder rapido immagini: [placehold.co](https://placehold.co/)

```html
<!-- Dopo il download, salva la foto in: img/profilo.jpg -->
<!-- Poi controlla che questo path funzioni nella tua pagina -->
<img src="img/profilo.jpg" alt="Foto ritratto di [nome]" />
```
...
## Istruzione 11
Verifica i punti minimi prima della consegna.

```html
<!-- Checklist minima -->
<!-- 1) h1 con il tuo nome -->
<!-- 2) almeno una foto con alt descrittivo -->
<!-- 3) almeno 3 interessi in lista -->
<!-- 4) almeno 1 link di contatto funzionante -->
<!-- 5) pagina validata su https://validator.w3.org/ -->
```

Ogni studente deve arrivare a una pagina personale diversa, con contenuti propri.
...
# Contrasto: crea un punto focale

- Il contrasto guida lo sguardo: oppone elementi (chiaro/scuro, saturo/desaturo, grande/piccolo).
- Gli accenti più “brillanti” attirano attenzione: usali per CTA e informazioni chiave.
- Troppi contrasti “forti” insieme = rumore visivo: neutrali come base, pochi accenti con ruolo chiaro.

<!--
Relatore:
- Collega al tema "gerarchia": non è solo tinta, ma anche luminosità + dimensione + spazio.
- Messaggio: decidi cosa deve emergere, poi riduci tutto il resto.
-->
...
<div class="color-wheel-layout">
  ...
  <div class="color-wheel-copy">
    <p><strong>Demo visiva:</strong> la tonalità (<code>Hue</code>) cambia in modo continuo su 360°.</p>
    <ul>
      <li>La ruota ruota per mostrare la continuità tra i colori.</li>
      <li>Il puntatore resta fisso: evidenzia “il colore corrente”.</li>
      <li>In UI, la leggibilità dipende sempre da contrasto e luminosità.</li>
    </ul>
  </div>
</div>
...
.color-wheel-ring {
  ...
  animation: color-wheel-spin 14s linear infinite;
...
.color-wheel-center {
  ...
  box-shadow: inset 0 4px 18px rgba(15, 23, 42, 0.12);
}
...
.color-wheel-pointer::after {
  ...
  animation: color-wheel-pulse 2.4s ease-in-out infinite;
}
...
<!--
Relatore:
- Usa questa slide per collegare "Hue = angolo" e transizione continua tra tonalita.
- Punto didattico: la ruota aiuta a scegliere armonie, ma contrasto e contesto decidono la leggibilita finale.
-->
...
# Significati culturali del colore (esempi)

- Il significato di un colore non è “universale”: è spesso **culturalmente codificato**.
- Un colore può indicare festa/fortuna in alcune culture e lutto/morte in altre.
- Anche associazioni comuni (es. “blu = fiducia”) cambiano in base a contesto, settore e pubblico.

Takeaway: evita regole assolute; se il target è misto, valida con esempi reali e aggiungi sempre testo/icone oltre al colore.

<!--
Relatore:
- Punto: psicologia del colore = indicazioni, ma senza contesto rischia di essere fuorviante.
- Esempio rapido: rosso/bianco assumono significati diversi in culture diverse.
-->
...
# Contesto culturale nel web design (un esempio)

Un modello utile: dimensioni culturali (Hofstede).

**Distanza dal potere: alta**
- informazioni molto strutturate e categorizzate
- tono più formale; enfasi su autorevolezza/esperti
- look più “istituzionale/nazionale” (immagini, colori, slogan)

::right::

**Distanza dal potere: bassa**
- più libertà di navigazione e scelte multiple
- tono più informale; attenzione alle persone
- errori “riparativi” e feedback più visibile

<!--
Relatore:
- Non è una regola rigida: è una lente utile per evitare proiezioni “occidentali” sul design.
- Domanda guida: "che cosa comunica questa UI a quel pubblico?".
-->
...
<InlineNotice label="Regole pratiche">
  WCAG da applicare durante progettazione e revisione.
</InlineNotice>

- testo e UI devono avere **contrasto sufficiente**
- per contenuti testuali (AA): rapporto minimo **4,5:1** tra testo e sfondo
...
<InlineNotice label="Obiettivi">
  Risultati attesi di un ciclo di usability testing.
</InlineNotice>
